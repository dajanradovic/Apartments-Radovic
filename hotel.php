...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Apartments Radovic | Apartment 4+0</title>
...
<body>
	...
	<!-- end:fh5co-header -->
	<div class="fh5co-parallax" style="background-image: url(images/velap_resized.jpg); background-position: 0% -120%;" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Apartment 4+0</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-hotel-section" style="background-color:#1f1d1d; padding-top:10px;">
		<div class="container">
			<div class="row">
								<p class="text-center lead"><i>Apartment 4+0 - a spacious apartment situated at the front part of the house. It consists of a kitchen with dining area, two bed-rooms with a double-bed, a bathroom, a hallway and a terrace.</i> </p>
  ...
  <div class="mySlides">
    <div class="numbertext">1 / 14</div>
      <img src="images/velap/1.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 14</div>
      <img src="images/velap/2.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 14</div>
      <img src="images/velap/3.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">4 / 14</div>
      <img src="images/velap/4.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">5 / 14</div>
      <img src="images/velap/5.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">6 / 14</div>
      <img src="images/velap/6.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">7 / 14</div>
      <img src="images/velap/7.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">8 / 14</div>
      <img src="images/velap/8.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">9 / 14</div>
      <img src="images/velap/9.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">10 / 14</div>
      <img src="images/velap/10.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">11 / 14</div>
      <img src="images/velap/11.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">12 / 14</div>
      <img src="images/velap/12.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">13 / 14</div>
      <img src="images/velap/13.jpg" style="width:100%">
  </div>
  <div class="mySlides">
    <div class="numbertext">14 / 14</div>
      <img src="images/velap/14.jpg" style="width:100%">
  </div>
  ...
  <div class="row" id="thumbnailsrow" style="margin-top:5px">
    <div class="column">
      <img class="demo cursor" src="images/velap/1.jpg" style="width:100%" onclick="currentSlide(1)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="images/velap/2.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/velap/3.jpg" style="width:100%" onclick="currentSlide(3)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="images/velap/4.jpg" style="width:100%" onclick="currentSlide(4)">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/velap/5.jpg" style="width:100%" onclick="currentSlide(5)"  >
    </div>
    <div class="column">
      <img class="demo cursor" src="images/velap/6.jpg" style="width:100%" onclick="currentSlide(6)" >
	</div>
	<div class="column">
		<img class="demo cursor" src="images/velap/7.jpg" style="width:100%" onclick="currentSlide(7)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/8.jpg" style="width:100%" onclick="currentSlide(8)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/9.jpg" style="width:100%" onclick="currentSlide(9)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/10.jpg" style="width:100%" onclick="currentSlide(10)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/11.jpg" style="width:100%" onclick="currentSlide(11)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/12.jpg" style="width:100%" onclick="currentSlide(12)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/13.jpg" style="width:100%" onclick="currentSlide(13)" >
	  </div>
	  <div class="column">
		<img class="demo cursor" src="images/velap/14.jpg" style="width:100%" onclick="currentSlide(14)" >
	  </div>
  </div>
</div>
	...
	<div class="container">
			...
			<div class="col-md-12">
							...
							<p style="text-decoration: underline;">Property surroundings:</p>
  ...
  <tbody>
    <tr>
      ...
      <td>35 &euro;</td>
		...
		<div class="col-md-12">
			<div class="row">
				<h1 class="contactUs" style="color:white;">Contact us</h1> <h6 class="contactUs" style="color:#848484">Do you want to book this apartment, please contact us and we will get in touch with you as soon as possible</h6>
				...
				<div class="col-md-6 formRows">
					<div class="form-group">
						<input type="text" name="apartment" class="form-control" value="apartment4+0" placeholder="Apartment 4+0" readonly>
					</div>
				</div>
